	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			const response = await fetch(
				"https://formsubmit.co/ajax/0880693abc403ed87229cfd57a6d4ac9",
				{
					method: "POST",
					headers: {
			...
			alert(
				"Error de conexión. Por favor, revisa tu conexión a internet.",
			);
			console.error(error);
		} finally {
			setLoading(false);
			...
			>
				...
				>
					...
					<p
						...
						style={{ margin: "0 auto" }}
					>
						Cuéntanos tu idea. Nuestro equipo te responde en
				...
				>
					...
					>
						<div>
							...
							>
								Desde la concepción de tu estudio de
								mercado hasta la entrega llave en mano,
								acompañamos cada etapa con precisión y
								visión.
							</p>
						</div>
					...
					>
						{submitted ? (
							...
							>
								...
								>
									Gracias por contactarnos. Nuestro
									equipo revisará tu solicitud y te
									responderá pronto.
								</p>
								<button
									onClick={() => {
							...
							>
								...
								>
									* Campos requeridos. Tu información
									es confidencial.
								</p>
							</form>
						)}
