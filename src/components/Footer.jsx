		...
		>
			...
			<div className="container footer-container" style={{}}>
				...
				>
					...
					>
						Contáctanos y descubre cómo podemos hacer realidad
						tu visión con la calidad y profesionalismo que nos
						caracterizan.
					</p>
					<a
						href="#contact"
				...
				>
					...
					<div>
						...
						>
							Innovación y calidad superior en cada
							proyecto de construcción.
						</p>
						<div style={{ display: "flex", gap: "1rem" }}>
							<a
								href="https://www.facebook.com/share/1HuQdPW6Wm/?mibextid=wwXIfr"
								target="_blank"
							...
							<a
								href="https://www.instagram.com/constructoraobr?igsh=YWg4Y2hjcHU2NmN2"
								target="_blank"
								rel="noopener noreferrer"
								style={{
									color: "var(--color-text-muted)",
				...
				>
					&copy; {new Date().getFullYear()} OBR Construcción ·
					Santa Cruz, Bolivia · Todos los derechos reservados.
				</div>
			</div>
