		...
		>
			...
			>
				...
				>
					...
					>
						Los pilares que sostienen cada proyecto y cada
						relación con nuestros clientes. No son sólo
						palabras — son el estándar con el que nos medimos
						cada día.
					</motion.p>
				</div>
						...
						<motion.div
							...
							onMouseOver={(e) => {
								...
								e.currentTarget.style.boxShadow =
									"0 15px 30px rgba(94, 25, 20, 0.08)";
