      ...
      <div className="container">
        ...
        >
          ...
          <div className="featured-service-left" style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            <p style={{ color: 'var(--color-text-muted)', lineHeight: 1.85, fontSize: '0.95rem' }}>
          ...
          <motion.div className="featured-service-right" style={{
            ...
            <h4 style={{ fontSize: '0.8rem', color: 'var(--color-text-muted)', fontWeight: 500, letterSpacing: '1px', textTransform: 'uppercase', marginBottom: '0.5rem' }}>
              ¿Qué incluye?
            </h4>
